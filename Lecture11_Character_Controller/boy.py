...
# 이벤트 정의
# RD, LD, RU, LU = 0, 1, 2, 3   버그 위험
RD, LD, RU, LU, aD, TIMER, AUTO = range(7)
...
class IDLE:
    ...
    @staticmethod
    def exit(self):     # 상태를 나올 때 행하는 액션, 고개 들기 등
        print('EXIT IDLE')
        pass
...
class Boy:
    ...
    def update(self):
        self.cur_state.do(self)     # 현재 상태의 do 액션을 수행
    ...
    def draw(self):
        self.cur_state.draw(self)   # 현 상태의 draw 액션
